...
import {
  climbingGrades as CGOptions,
  yearsExpOptions,
  climbingStyles,
} from "../../../data/ModalPickerOptions"
...
export const ClimbingStyleModal = (props: ClimbingStyleModalProps) => {
  ...
  useEffect(() => {
    if (climbingStyle === "Sport Climbing" || climbingStyle === "Top Rope") {
    ...
    <Modal visible={visible} animationType="slide">
      ...
      <View style={$modalContainerStyle}>
        ...
        <Button
          ...
          style={$buttonStyle}
          LeftAccessory={() => <Icon icon={"plus"} color={colors.background} />}
        />
      </View>
    </Modal>
  )
